    ...
    `);
      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-63edc653.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
      ...
      */
      ...
      register('video', {
        ...
        onLoad() {
          module.import('./fluorescent-video.es-89769ac4.nomodule.js').then(({
            default: Video
          }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-25a591e6.nomodule.js').then(({
          default: filtering
        }) => {
      ...
      window.SHA = '54b1986671';

    })
  };
}));
//# sourceMappingURL=theme-1f534762.nomodule.js.map
